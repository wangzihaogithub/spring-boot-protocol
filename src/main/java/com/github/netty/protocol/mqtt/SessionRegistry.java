...
import com.github.netty.protocol.mqtt.Session.SessionStatus;
...
public class SessionRegistry {
    ...
    public SessionRegistry(ISubscriptionsDirectory subscriptionsDirectory, IQueueRepository queueRepository) {
