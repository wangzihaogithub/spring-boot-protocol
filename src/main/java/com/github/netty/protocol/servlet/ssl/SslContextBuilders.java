...
public class SslContextBuilders {
    ...
    public static SslContext newSslContextJks(File jksKeyFile, File jksPassword) throws IOException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyStoreException, CertificateException {
        ...
        return newSslContextJks(jksKeyFile, password);
    }

    public static SslContext newSslContextJks(File jksKeyFile, String jksPassword) throws IOException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyStoreException, CertificateException {
    ...
    public static SslContext newSslContext(SslContextBuilder builder) throws SSLException {
